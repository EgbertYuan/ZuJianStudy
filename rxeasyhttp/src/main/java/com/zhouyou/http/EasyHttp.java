...
public final class EasyHttp {
     ...
     * get请求
     */
    public static GetRequest get(String url, String sec, String ticks) {
        return new GetRequest(url).params("sec", sec).params("ticks", ticks);
    }
     ...
     *
     * @param url
     * @param map 包含请求参数的mao集合
     * @return
     */
    public static GetRequest get(String url, Map<String, Object> map) {
        GetRequest getRequest = new GetRequest(url);
        for (String key : map.keySet()) {
            getRequest.params(key, String.valueOf(map.get(key)));
        }
        return getRequest;
    }
